...
import com.soft.repository.ProductoRepository;
import com.soft.service.ProductoService;
import com.soft.service.dto.ProductoDTO;
import com.soft.service.mapper.ProductoMapper;
import com.soft.service.dto.ProductoCriteria;
import com.soft.service.ProductoQueryService;
...
public class ProductoResourceIT {
    ...
    private static final Double DEFAULT_PRECION = 1D;
    private static final Double UPDATED_PRECION = 2D;
    private static final Double SMALLER_PRECION = 1D - 1D;
    ...
    public void createProducto() throws Exception {
        ...
        assertThat(testProducto.getPrecion()).isEqualTo(DEFAULT_PRECION);
    }
    ...
    public void getAllProductos() throws Exception {
        ...
        restProductoMockMvc.perform(get("/api/productos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].precion").value(hasItem(DEFAULT_PRECION.doubleValue())));
    }
    ...
    public void getProducto() throws Exception {
        ...
        restProductoMockMvc.perform(get("/api/productos/{id}", producto.getId()))
            ...
            .andExpect(jsonPath("$.precion").value(DEFAULT_PRECION.doubleValue()));
    }
    ...
    @Test
    @Transactional
    public void getAllProductosByPrecionIsEqualToSomething() throws Exception {
        // Initialize the database
        productoRepository.saveAndFlush(producto);

        // Get all the productoList where precion equals to DEFAULT_PRECION
        defaultProductoShouldBeFound("precion.equals=" + DEFAULT_PRECION);

        // Get all the productoList where precion equals to UPDATED_PRECION
        defaultProductoShouldNotBeFound("precion.equals=" + UPDATED_PRECION);
    }

    @Test
    @Transactional
    public void getAllProductosByPrecionIsNotEqualToSomething() throws Exception {
        // Initialize the database
        productoRepository.saveAndFlush(producto);

        // Get all the productoList where precion not equals to DEFAULT_PRECION
        defaultProductoShouldNotBeFound("precion.notEquals=" + DEFAULT_PRECION);

        // Get all the productoList where precion not equals to UPDATED_PRECION
        defaultProductoShouldBeFound("precion.notEquals=" + UPDATED_PRECION);
    }

    @Test
    @Transactional
    public void getAllProductosByPrecionIsInShouldWork() throws Exception {
        // Initialize the database
        productoRepository.saveAndFlush(producto);

        // Get all the productoList where precion in DEFAULT_PRECION or UPDATED_PRECION
        defaultProductoShouldBeFound("precion.in=" + DEFAULT_PRECION + "," + UPDATED_PRECION);

        // Get all the productoList where precion equals to UPDATED_PRECION
        defaultProductoShouldNotBeFound("precion.in=" + UPDATED_PRECION);
    }

    @Test
    @Transactional
    public void getAllProductosByPrecionIsNullOrNotNull() throws Exception {
        // Initialize the database
        productoRepository.saveAndFlush(producto);

        // Get all the productoList where precion is not null
        defaultProductoShouldBeFound("precion.specified=true");

        // Get all the productoList where precion is null
        defaultProductoShouldNotBeFound("precion.specified=false");
    }

    @Test
    @Transactional
    public void getAllProductosByPrecionIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        productoRepository.saveAndFlush(producto);

        // Get all the productoList where precion is greater than or equal to DEFAULT_PRECION
        defaultProductoShouldBeFound("precion.greaterThanOrEqual=" + DEFAULT_PRECION);

        // Get all the productoList where precion is greater than or equal to UPDATED_PRECION
        defaultProductoShouldNotBeFound("precion.greaterThanOrEqual=" + UPDATED_PRECION);
    }

    @Test
    @Transactional
    public void getAllProductosByPrecionIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        productoRepository.saveAndFlush(producto);

        // Get all the productoList where precion is less than or equal to DEFAULT_PRECION
        defaultProductoShouldBeFound("precion.lessThanOrEqual=" + DEFAULT_PRECION);

        // Get all the productoList where precion is less than or equal to SMALLER_PRECION
        defaultProductoShouldNotBeFound("precion.lessThanOrEqual=" + SMALLER_PRECION);
    }

    @Test
    @Transactional
    public void getAllProductosByPrecionIsLessThanSomething() throws Exception {
        // Initialize the database
        productoRepository.saveAndFlush(producto);

        // Get all the productoList where precion is less than DEFAULT_PRECION
        defaultProductoShouldNotBeFound("precion.lessThan=" + DEFAULT_PRECION);

        // Get all the productoList where precion is less than UPDATED_PRECION
        defaultProductoShouldBeFound("precion.lessThan=" + UPDATED_PRECION);
    }

    @Test
    @Transactional
    public void getAllProductosByPrecionIsGreaterThanSomething() throws Exception {
        // Initialize the database
        productoRepository.saveAndFlush(producto);

        // Get all the productoList where precion is greater than DEFAULT_PRECION
        defaultProductoShouldNotBeFound("precion.greaterThan=" + DEFAULT_PRECION);

        // Get all the productoList where precion is greater than SMALLER_PRECION
        defaultProductoShouldBeFound("precion.greaterThan=" + SMALLER_PRECION);
    }
    ...
    public void updateProducto() throws Exception {
        ...
        assertThat(testProducto.getPrecion()).isEqualTo(UPDATED_PRECION);
    }
