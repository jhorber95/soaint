...
describe('Cliente e2e test', () => {
  ...
  it('should load Clientes', async () => {
    ...
    expect(await clienteComponentsPage.getTitle()).to.eq('soaintApp.cliente.home.title');
  ...
  it('should load create Cliente page', async () => {
    ...
    expect(await clienteUpdatePage.getPageTitle()).to.eq('soaintApp.cliente.home.createOrEditLabel');
  ...
  it('should create and save Clientes', async () => {
    ...
    expect(await clienteUpdatePage.getDniInput()).to.eq('dni', 'Expected Dni value to be equals to dni');
  ...
  it('should delete last Cliente', async () => {
    ...
    expect(await clienteDeleteDialog.getDialogTitle()).to.eq('soaintApp.cliente.delete.question');
